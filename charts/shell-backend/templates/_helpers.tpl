...
Common labels
*/}}
{{- define "shell-backend.labels" -}}
helm.sh/chart: {{ include "shell-backend.chart" . }}
{{ include "shell-backend.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "shell-backend.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "shell-backend.fullname" .) .Values.serviceAccount.name }}
{{- else }}
